...
const initDb = async () => {
    ...
    await client.query(`
      UPDATE locations 
      SET address = 'ศาลาว่าการกทม.2 ถ.มิตรไมตรี เขตดินแดง กรุงเทพมหานคร 10400',
          contact_name = 'ป้อม',
    ...
    const criticalLocs = [
      { name: 'โรงพยาบาลพระมงกุฎเกล้า', lat: 13.767815469271792, lng: 100.53436960291768, address: '315 ถ. ราชวิถี แขวงทุ่งพญาไท เขตราชเทวี กรุงเทพมหานคร 10400' },
      { name: 'กองงานในพระองค์สมเด็จพระกนิษฐาธิราชเจ้ากรมสมเด็จพระเทพรัตนราชสุดาฯ สยามบรมราชกุมารี', lat: 13.771605534641719, lng: 100.51948264605969, address: 'อาคารชัยพัฒนา สวนจิตรลดา ถ. ราชวิถี แขวงสวนจิตรลดา เขตดุสิต กรุงเทพมหานคร 10303' },
      { name: 'บริษัท โรงพยาบาล ไอเอ็มเอช สีลม', lat: 13.725312330892336, lng: 100.51932468221379 },
      { name: 'มูลนิธิโรงพยาบาลตำรวจในพระบรมราชินูปถัมภ์ (โครงการร้านยา)', lat: 13.742650459886534, lng: 100.53857170712914, address: '492/1 โรงพยาบาลตำรวจ อาคารมหาภูมิพลราชานุสรณ์ 88 พรรษา ชั้น 2 ถ.พระรามที่ 1 แขวงปทุมวัน เขตปทุมวัน กรุงเทพฯ 10330' },
      { name: 'โรงพยาบาลทหารผ่านศึก', lat: 13.7721515, lng: 100.5518272 },
      { name: 'กรมแผนที่ทหาร', lat: 13.792762681928684, lng: 100.59635918952853, address: '1770 ถนนลาดพร้าว เขตวังทองหลาง แขวงวังทองหลาง กรุงเทพฯ 10310' },
      { name: 'องค์การเภสัชกรรม สำนักงานใหญ่', lat: 13.759, lng: 100.528 },
      { name: 'กรมการแพทย์ กระทรวงสาธารณสุข', lat: 13.848212224077287, lng: 100.52818072831043, address: '88/23 ถ.ติวานนท์ ต.ตลาดขวัญ อ.เมือง จ.นนทบุรี 11000' },
      { name: 'โรงพยาบาลสมเด็จพระปิ่นเกล้า', lat: 13.709451334752874, lng: 100.48589855522276 },
      { name: 'กรมแพทย์ทหารเรือ', lat: 13.709451334752874, lng: 100.48589855522276, address: '504 ถนน สมเด็จพระเจ้าตากสิน แขวงบุคคโล เขตธนบุรี กรุงเทพมหานคร 10600' },
      { name: 'กรมแพทย์ทหารอากาศ', lat: 13.910432554429995, lng: 100.61869492061746, address: '171 ถ.พหลโยธิน แขวงคลองถนน เขตสายไหม กรุงเทพมหานคร 10220' },
      { name: 'บริษัท กรุงเทพดรักสโตร์ จำกัด', lat: 13.7812722378695, lng: 100.61883196681411, address: '2585 2 ซอย ลาดพร้าว 87/1 แขวงคลองเจ้าคุณสิงห์ เขตวังทองหลาง กรุงเทพมหานคร 10130' }
    ];
    ...
    await client.query(`
      ...
      VALUES ('ธนาคารทีทีบี สำนักงานใหญ่พหลโยธิน', 'Zone 3: จตุจักร / บางซื่อ / พหลโยธิน / งามวงศ์วาน / นนทบุรี', '3000 ถนนพหลโยธิน แขวงจอมพล เขตจตุจักร กรุงเทพมหานคร 10900', 13.804, 100.560)
    ...
    // Migration: Enrich all location addresses with full postal details
    const addressUpdates = [
      ['สถาบันวิจัยวิทยาศาสตร์การแพทย์ทหาร', '315/6 ถ.ราชวิถี แขวงทุ่งพญาไท เขตราชเทวี กรุงเทพมหานคร 10400'],
      ['กองคลังแพทย์ กรมแพทย์ทหารบก', 'ถ.พญาไท แขวงทุ่งพญาไท เขตราชเทวี กรุงเทพมหานคร 10400'],
      ['กรมแผนที่ทหาร', 'ถ.กัลยาณไมตรี แขวงพระบรมมหาราชวัง เขตพระนคร กรุงเทพมหานคร 10200'],
      ['กองงานในพระองค์สมเด็จพระกนิษฐาราชเจ้ากรมสมเด็จพระเทพรัตนราชสุดาฯ สยามบรมราชกุมารี', 'พระตำหนักจิตรลดารโหฐาน ถ.ราชวิถี แขวงสวนจิตรลดา เขตดุสิต กรุงเทพมหานคร 10303'],
      ['โรงเรียนช่างฝีมือทหาร สถาบันวิชาการป้องกันประเทศ', '3/1 ซอยพหลโยธิน 30 แขวงจันทรเกษม เขตจตุจักร กรุงเทพมหานคร 10900'],
      ['ทัณฑสถานโรงพยาบาลราชทัณฑ์', '33 ถ.งามวงศ์วาน แขวงลาดยาว เขตจตุจักร กรุงเทพมหานคร 10900'],
      ['แผนกแพทย์ กองบริหาร กรมช่างอากาศ', '171 ถ.พหลโยธิน แขวงจันทรเกษม เขตจตุจักร กรุงเทพมหานคร 10900'],
      ['การไฟฟ้าฝ่ายผลิตแห่งประเทศไทย', '53 ถ.จรัญสนิทวงศ์ ต.บางกรวย อ.บางกรวย จ.นนทบุรี 11130'],
      ['กรมการแพทย์ กระทรวงสาธารณสุข', '88/23 ถ.ติวานนท์ ต.ตลาดขวัญ อ.เมืองนนทบุรี จ.นนทบุรี 11000'],
      ['กรมแพทย์ทหารอากาศ', '171 ถ.พหลโยธิน แขวงคลองถนน เขตสายไหม กรุงเทพมหานคร 10220'],
      ['สถาบันเวชศาสตร์การบิน กองทัพอากาศ', '171 ถ.พหลโยธิน แขวงคลองถนน เขตสายไหม กรุงเทพมหานคร 10220'],
      ['โรงพยาบาลทหารอากาศ (สีกัน)', '238 ถ.พหลโยธิน แขวงสีกัน เขตดอนเมือง กรุงเทพมหานคร 10210'],
      ['ศูนย์รักษาความปลอดภัย กองบัญชาการกองทัพไทย', 'ถ.แจ้งวัฒนะ แขวงอนุสาวรีย์ เขตบางเขน กรุงเทพมหานคร 10220'],
      ['สสน.นทพ.', 'ถ.แจ้งวัฒนะ แขวงทุ่งสองห้อง เขตหลักสี่ กรุงเทพมหานคร 10210'],
      ['โรงพยาบาลสมเด็จพระปิ่นเกล้า', '504 ถ.สมเด็จพระเจ้าตากสิน แขวงบุคคโล เขตธนบุรี กรุงเทพมหานคร 10600'],
      ['กรมแพทย์ทหารเรือ', 'ถ.สมเด็จพระเจ้าตากสิน แขวงบุคคโล เขตธนบุรี กรุงเทพมหานคร 10600'],
      ['บริษัท กรุงเทพดรักสโตร์ จำกัด', '2585/2 ถ.ลาดพร้าว แขวงคลองเจ้าคุณสิงห์ เขตวังทองหลาง กรุงเทพมหานคร 10310'],
      ['โรงพยาบาลทหารเรือกรุงเทพ', '880 ถ.สรรพาวุธ แขวงบางนา เขตบางนา กรุงเทพมหานคร 10260'],
      ['บริษัท สินแพทย์ เทพารักษ์ จำกัด', '9/99 หมู่ 6 ถ.เทพารักษ์ ต.เทพารักษ์ อ.เมืองสมุทรปราการ จ.สมุทรปราการ 10270'],
      ['บริษัท พีเอ็มเควิทยาเวช จำกัด (ร้านยาสิรินธรโอสถ รพ.พระมงกุฎ)', 'อาคารเฉลิมพระเกียรติสมเด็จพระนางเจ้าสิริกิติ์ ชั้น G เลขที่ 315 ถนนราชวิถี แขวงทุ่งพญาไท เขตราชเทวี กรุงเทพมหานคร 10400']
    ];
    for (const [name, address] of addressUpdates) {
      await client.query('UPDATE locations SET address = $1 WHERE name = $2 AND (address IS NULL OR address = \'\')', [address, name]);
    }
