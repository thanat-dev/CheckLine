...
const initDb = async () => {
    ...
    if (parseInt(locCheck.rows[0].count) === 0) {
      ...
      const defaultLocs = [
        ...
        ['โรงพยาบาลวิภาวดี (กรุงเทพฯ)', 'Zone 3: จตุจักร / นนทบุรี'],
        ['โรงเรียนช่างฝีมือทหาร สถาบันวิชาการป้องกันประเทศ', 'Zone 3: จตุจักร / นนทบุรี'],
        ['ทัณฑสถานโรงพยาบาลราชทัณฑ์', 'Zone 3: จตุจักร / นนทบุรี'],
        ['แผนกแพทย์ กองบริหาร กรมช่างอากาศ', 'Zone 3: จตุจักร / นนทบุรี'],
        ['การไฟฟ้าฝ่ายผลิตแห่งประเทศไทย', 'Zone 3: จตุจักร / นนทบุรี'],
        ['กรมการแพทย์ กระทรวงสาธารณสุข', 'Zone 3: จตุจักร / นนทบุรี'],
