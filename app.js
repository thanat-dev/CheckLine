...
const ZONE_MAP = {
  ...
  'มูลนิธิโรงพยาบาลตำรวจในพระบรมราชินูปถัมภ์ (โครงการร้านยา)': { zone: 'Zone 5: ปทุมวัน / ดินแดง', order: 2 },
  'กลุ่มงานเวชภัณฑ์ กองเภสัชกรรม สำนักอนามัย': { zone: 'Zone 5: ปทุมวัน / ดินแดง', order: 2 },
